...
// EXTERNAL MODULE: ../dr branding/node_modules/remotion/dist/esm/index.mjs
var esm = __webpack_require__(6675);
// EXTERNAL MODULE: ../dr branding/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(7668);
;// CONCATENATED MODULE: ./src/compositions/BrandIntro.tsx



const BrandIntroComposition = ({
  companyName,
  tagline,
  logoUrl,
  primaryColor,
  ...
  const sweepScale = (0,esm.interpolate)(frame, [0, 25], [0, 1], {
  ...
  const nameY = (0,esm.interpolate)(frame, [55, 85], [40, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const nameOpacity = (0,esm.interpolate)(frame, [55, 85], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const taglineOpacity = (0,esm.interpolate)(frame, [95, 120], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: logoUrl ? /* @__PURE__ */ (0,jsx_runtime.jsx)("img", { src: logoUrl, alt: "logo", style: { width: "100%", height: "100%", objectFit: "contain" } }) : /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 48, fontWeight: 800, color: primaryColor }, children: initials })
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
...
;// CONCATENATED MODULE: ./src/compositions/TextAnimation.tsx



const TextAnimationComposition = ({
  text,
  subtext,
  animationStyle,
  backgroundColor,
  ...
  const fadeOpacity = (0,esm.interpolate)(frame, [0, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const slideY = (0,esm.interpolate)(frame, [0, 30], [60, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const subtextOpacity = (0,esm.interpolate)(frame, [40, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const accentScale = (0,esm.interpolate)(frame, [10, 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const renderText = () => {
    if (animationStyle === "stagger" || animationStyle === "kinetic") {
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: 16, justifyContent: "center" }, children: words.map((word, i) => {
        const wordSpring = (0,esm.spring)({
          frame: frame - i * 6,
          fps,
          config: { damping: 80, stiffness: 150, mass: 0.8 }
        });
        const wordOpacity = (0,esm.interpolate)(frame, [i * 6, i * 6 + 20], [0, 1], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
            style: {
              ...
              opacity: wordOpacity,
              transform: `translateY(${(0,esm.interpolate)(wordSpring, [0, 1], [40, 0])}px)`,
    ...
    if (animationStyle === "mask") {
      const clipWidth = (0,esm.interpolate)(frame, [0, 40], [0, 100], {
        extrapolateLeft: "clamp",
        extrapolateRight: "clamp"
      });
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { overflow: "hidden", clipPath: `inset(0 ${100 - clipWidth}% 0 0)` }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 72, fontWeight: 800, color: textColor, letterSpacing: -2, whiteSpace: "nowrap" }, children: text }) });
    }
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          textAlign: "center",
          opacity: fadeOpacity,
          transform: animationStyle === "slide-up" ? `translateY(${slideY}px)` : void 0,
          maxWidth: 900
        },
        children: text
      }
...
;// CONCATENATED MODULE: ./src/compositions/CarouselToVideo.tsx
...
function Slide({
  ...
  const titleY = (0,esm.interpolate)(localFrame, [0, 20], [30, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const bodyOpacity = (0,esm.interpolate)(localFrame, [15, 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (localFrame < 0 || localFrame >= framesPerSlide) return null;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { fontFamily, backgroundColor: "#111" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: 8, backgroundColor: brandColor } }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", top: 40, right: 48, fontSize: 16, color: `${textColor}60`, fontWeight: 500, letterSpacing: 2 }, children: [
      slideNumber,
      " / ",
      total
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      esm.AbsoluteFill,
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 58, fontWeight: 800, color: textColor, letterSpacing: -2, lineHeight: 1.15, transform: `translateY(${titleY}px)` }, children: title }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 56, height: 4, backgroundColor: accentColor, borderRadius: 2 } }),
          body && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 28, color: `${textColor}cc`, lineHeight: 1.5, opacity: bodyOpacity, maxWidth: 840 }, children: body })
        ]
      }
    )
  ] });
}
const CarouselToVideoComposition = ({
  slides,
  brandColor,
  accentColor,
  textColor,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#111", fontFamily }, children: [
    slides.map((slide, idx) => {
      const startFrame = idx * framesPerSlide;
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: startFrame, durationInFrames: framesPerSlide, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        Slide,
        {
          title: slide.title,
          body: slide.body,
    ...
    clientName && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: 32, left: 48, fontSize: 16, color: `${textColor}40`, fontWeight: 500, letterSpacing: 1 }, children: clientName })
  ] });
};

;// CONCATENATED MODULE: ./src/compositions/PromoVideo.tsx



const PromoVideoComposition = ({
  headline,
  subheadline,
  bodyText,
  cta,
  ...
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const gradientPos = (0,esm.interpolate)(frame, [0, 180], [0, 30], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const headlineSpring = (0,esm.spring)({ frame: frame - 10, fps, config: { damping: 100, stiffness: 150, mass: 1 } });
  const headlineOpacity = (0,esm.interpolate)(frame, [10, 35], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const subOpacity = (0,esm.interpolate)(frame, [40, 65], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const subY = (0,esm.interpolate)(frame, [40, 65], [20, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const bodyOpacity = (0,esm.interpolate)(frame, [65, 90], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const ctaOpacity = (0,esm.interpolate)(frame, [120, 145], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const ctaScale = (0,esm.spring)({ frame: frame - 120, fps, config: { damping: 80, stiffness: 300, mass: 0.6 } });
  const logoOpacity = (0,esm.interpolate)(frame, [0, 25], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { fontFamily, background: `linear-gradient(${135 + gradientPos}deg, ${secondaryColor} 0%, ${primaryColor}33 100%)` }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: "linear-gradient(to bottom, transparent 30%, rgba(0,0,0,0.7) 100%)" } }),
    logoUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: 48, left: 56, opacity: logoOpacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("img", { src: logoUrl, alt: "logo", style: { height: 48, objectFit: "contain" } }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "0 72px 96px", gap: 24 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 72, fontWeight: 900, color: textColor, letterSpacing: -3, lineHeight: 1.05, opacity: headlineOpacity, transform: `translateY(${(0,esm.interpolate)(headlineSpring, [0, 1], [40, 0])}px)`, maxWidth: 900 }, children: headline }),
      subheadline && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 32, fontWeight: 600, color: `${textColor}cc`, opacity: subOpacity, transform: `translateY(${subY}px)` }, children: subheadline }),
      bodyText && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 24, fontWeight: 400, color: `${textColor}99`, opacity: bodyOpacity, lineHeight: 1.5, maxWidth: 780 }, children: bodyText }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: (0,esm.interpolate)(frame, [80, 105], [0, 72], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }), height: 4, backgroundColor: primaryColor, borderRadius: 2 } }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: ctaOpacity, transform: `scale(${ctaScale})`, transformOrigin: "left center", alignSelf: "flex-start" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { backgroundColor: primaryColor, color: secondaryColor, fontSize: 22, fontWeight: 700, padding: "16px 40px", borderRadius: 8 }, children: cta }) })
    ] })
  ] });
};

;// CONCATENATED MODULE: ./src/compositions/ReportVideo.tsx



function AnimatedCounter({ value, startFrame, fps, color, fontSize = 64 }) {
  const frame = (0,esm.useCurrentFrame)();
  const isNumeric = typeof value === "number";
  if (!isNumeric) {
    const opacity = (0,esm.interpolate)(frame, [startFrame, startFrame + 20], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color, fontSize, fontWeight: 800, opacity }, children: value });
  }
  const progress = (0,esm.spring)({ frame: frame - startFrame, fps, config: { damping: 60, stiffness: 80, mass: 1.2 } });
  const displayed = Math.round(progress * value);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color, fontSize, fontWeight: 800 }, children: displayed });
}
const ReportVideoComposition = ({
  clientName,
  month,
  kpis,
  highlights,
  ...
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const headerOpacity = (0,esm.interpolate)(frame, [0, 20], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const dividerScale = (0,esm.interpolate)(frame, [15, 35], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#0d0d0d", fontFamily, padding: "72px 80px" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: 0, top: 0, bottom: 0, width: 6, backgroundColor: primaryColor } }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity: headerOpacity, marginBottom: 48 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 18, color: accentColor, fontWeight: 600, letterSpacing: 3, textTransform: "uppercase", marginBottom: 12 }, children: "Monthly Report" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 52, fontWeight: 800, color: textColor, letterSpacing: -2, lineHeight: 1.1 }, children: clientName }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 24, color: `${textColor}80`, marginTop: 8 }, children: month })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: `${dividerScale * 100}%`, height: 2, backgroundColor: `${textColor}20`, marginBottom: 48 } }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32, marginBottom: 56 }, children: kpis.slice(0, 3).map((kpi, idx) => {
      const kpiOpacity = (0,esm.interpolate)(frame, [40 + idx * 12, 60 + idx * 12], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity: kpiOpacity, backgroundColor: `${textColor}08`, borderRadius: 16, padding: "28px 32px", border: `1px solid ${textColor}12` }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 13, color: `${textColor}60`, fontWeight: 500, letterSpacing: 2, textTransform: "uppercase", marginBottom: 12 }, children: kpi.label }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(AnimatedCounter, { value: kpi.value, startFrame: 40 + idx * 12, fps, color: accentColor, fontSize: 52 }),
        kpi.unit && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 24, color: `${accentColor}80`, fontWeight: 400, marginLeft: 4 }, children: kpi.unit })
      ] }, kpi.label);
    }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 14, color: `${textColor}60`, fontWeight: 600, letterSpacing: 3, textTransform: "uppercase", marginBottom: 20, opacity: (0,esm.interpolate)(frame, [110, 130], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }) }, children: "Key Highlights" }),
      highlights.slice(0, 3).map((h, idx) => {
        const hOpacity = (0,esm.interpolate)(frame, [120 + idx * 15, 140 + idx * 15], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
        const hX = (0,esm.interpolate)(frame, [120 + idx * 15, 140 + idx * 15], [-20, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
        return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: 16, opacity: hOpacity, transform: `translateX(${hX}px)`, marginBottom: 16 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 6, height: 6, borderRadius: "50%", backgroundColor: accentColor, marginTop: 9, flexShrink: 0 } }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 22, color: `${textColor}cc`, lineHeight: 1.4 }, children: h })
        ] }, idx);
      })
    ] })
  ] });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        ...
        height: 1080,
        defaultProps: {
          companyName: "DR Branding",
          tagline: "Your Brand. Your Story.",
          primaryColor: "#c9a96e",
      ...
      esm.Composition,
      {
        ...
        defaultProps: {
          ...
          highlights: [
            ...
            "Reels outperformed static posts by 3\xD7 average reach.",
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3449);
...
*/
var aa=__webpack_require__(3449),ca=__webpack_require__(3424);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var m = __webpack_require__(7453);
if (true) {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(3449),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
if (true) {
  module.exports = __webpack_require__(9682);
} else {}
...
if (true) {
  module.exports = __webpack_require__(8115);
} else {}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3449);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6250);
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6675);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3714);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7668);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(611), __webpack_require__.e(869), __webpack_require__.e(943)]).then(__webpack_require__.bind(__webpack_require__, 1869)).then(({ StudioInternals }) => {
...
if (typeof window !== "undefined") {
  const getUnevaluatedComps = () => {
    ...
    if (!canSerializeDefaultProps) {
      remotion__WEBPACK_IMPORTED_MODULE_2__.Internals.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "defaultProps are too big to serialize - trying to find the problematic composition...");
      remotion__WEBPACK_IMPORTED_MODULE_2__.Internals.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Serialization:", compositions);
      ...
      remotion__WEBPACK_IMPORTED_MODULE_2__.Internals.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Could not single out a problematic composition -  The composition list as a whole is too big to serialize.");
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3449);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7453);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7668);
...
var SequenceManagerProvider = ({ children, visualModeEnabled }) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(SequenceManager.Provider, {
    ...
    children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(SequenceVisibilityToggleContext.Provider, {
      value: hiddenContext,
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(VisualModeOverridesContext.Provider, {
...
var wrapInSchema = (Component, schema) => {
  ...
  const Wrapped = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)((props, ref) => {
    const env = useRemotionEnvironment();
    const { visualModeEnabled, dragOverrides, codeValues } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(VisualModeOverridesContext);
    ...
    const valuesDotNotation = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
...
var HtmlInCanvasInner = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({
  ...
  const chainState = useEffectChainState();
  const effectsRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(effects);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "dr-branding-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdr_branding_remotion"] = self["webpackChunkdr_branding_remotion"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__(2123);
/******/ 	
/******/ })()
;
