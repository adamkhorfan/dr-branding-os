...
export const TEMPLATE_REGISTRY: Record<TemplateKey, TemplateRegistryEntry> = {
  "brand-intro": {
    ...
    defaultProps: DEFAULT_BRAND_INTRO_PROPS as unknown as Record<string, unknown>,
  ...
  "text-animation": {
    ...
    defaultProps: DEFAULT_TEXT_ANIMATION_PROPS as unknown as Record<string, unknown>,
  ...
  "carousel-to-video": {
    ...
    defaultProps: DEFAULT_CAROUSEL_PROPS as unknown as Record<string, unknown>,
    durationInFrames:
  ...
  "promo-video": {
    ...
    defaultProps: DEFAULT_PROMO_PROPS as unknown as Record<string, unknown>,
  ...
  "report-video": {
    ...
    defaultProps: DEFAULT_REPORT_PROPS as unknown as Record<string, unknown>,
